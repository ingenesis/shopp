	...
	<?php if (count($Categories) > 0): ?>
		...
		foreach ( $columns as $column => $column_title ) {
			...
			switch ($column) {
				...
				?>
					<td class="<?php echo esc_attr(join(' ',$classes)); ?>"><a class='row-title' href='<?php echo $editurl; ?>' title='<?php Shopp::_e('Edit'); ?> &quot;<?php echo esc_attr($CategoryName); ?>&quot;'><?php echo str_repeat("&#8212; ",$Category->level); echo esc_html($CategoryName); ?></a>
						<div class="row-actions">
							<span class='edit'><a href="<?php echo esc_url($editurl); ?>" title="<?php Shopp::_e('Edit'); ?> &quot;<?php echo esc_attr($CategoryName); ?>&quot;"><?php Shopp::_e('Edit'); ?></a> | </span>
							<span class='delete'><a class='submitdelete' title='<?php Shopp::_e('Delete'); ?> &quot;<?php echo esc_attr($CategoryName); ?>&quot;' href="<?php echo esc_url($deleteurl); ?>" rel="<?php echo $Category->id; ?>"><?php Shopp::_e('Delete'); ?></a> | </span>
