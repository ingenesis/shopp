<div class="wrap shopp">
	...
	<?php if (count($Customers) > 0): ?>
		...
		<tr<?php if (!$even) echo " class='alternate'"; $even = !$even; ?>>
			...
			<td class="customer-name column-customer-name"><a class='row-title' href='<?php echo esc_url( add_query_arg(array('page'=>'shopp-customers','id'=>$Customer->id),admin_url('admin.php'))); ?>' title='<?php Shopp::_e('Edit'); ?> &quot;<?php echo esc_attr($CustomerName); ?>&quot;'><?php echo esc_html($CustomerName); ?></a><?php echo !empty($Customer->company)?"<br />".esc_html($Customer->company):""; ?></td>
