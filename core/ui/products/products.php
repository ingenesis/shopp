			...
			foreach ( $columns as $column => $column_title ) {
				...
				switch ($column) {
					...
					?>
						...
						<strong><?php if ( $is_trash ): ?><?php echo esc_html($ProductName); ?><?php else: ?><a class='row-title' href='<?php echo $editurl; ?>' title='<?php Shopp::_e('Edit'); ?> &quot;<?php echo esc_attr($ProductName); ?>&quot;'>
						...
						<?php echo esc_html($ProductName); ?></a><?php endif; ?></strong>
							<?php if ( $is_trash ): ?>
								<div class="row-actions">
									...
									<span class='delete'><a title="<?php echo esc_attr(sprintf(__('Delete %s permanently', 'Shopp'), "&quot;$ProductName&quot;")); ?>" href="<?php echo $delurl; ?>" rel="<?php echo $Product->id; ?>"><?php Shopp::_e('Delete Permanently'); ?></a></span>
								</div>
							<?php else: ?>
							<div class="row-actions">
								<span class='edit'><a href="<?php echo $editurl; ?>" title="<?php Shopp::_e('Edit'); ?> &quot;<?php echo esc_attr($ProductName); ?>&quot;"><?php Shopp::_e('Edit'); ?></a> | </span>
								<span class='edit'><a href="<?php echo $dupurl; ?>" title="<?php Shopp::_e('Duplicate'); ?> &quot;<?php echo esc_attr($ProductName); ?>&quot;"><?php Shopp::_e('Duplicate'); ?></a> | </span>
