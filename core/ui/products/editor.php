...
var product = <?php echo (!empty($Product->id))?$Product->id:'false'; ?>,
	...
	fileupload_url = '<?php echo wp_nonce_url(admin_url()."admin-ajax.php?action=shopp_upload_file", "wp_ajax_shopp_upload_file"); ?>',
	...
	filesizeLimit = <?php echo wp_convert_hr_to_bytes( ini_get( 'post_max_size' ) ) / MB_IN_BYTES; ?>,
    chunksizeLimit = <?php echo wp_max_upload_size(); ?>,
